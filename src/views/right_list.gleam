...
pub type RightListProps(msg) {
  RightListProps(name: String, data: List(String))
}

pub fn view(props: RightListProps(state.Msg)) -> element.Element(state.Msg) {
      ...
      [
        ...
        html.button(
          [
            ...
            event.on_click(state.UserSortRightList),
          ],
          [
            html.img([
